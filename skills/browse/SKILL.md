---
name: browse
description: Automated browser testing via Playwright MCP. Navigates pages, clicks safe interactive elements, captures console errors and failed network requests. Classifies findings and optionally auto-fixes source issues. Use when user says "test pages", "smoke test", "check console errors", "browse test".
